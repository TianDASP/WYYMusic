...
{
    public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<WYYMusicDbContext>
    {
        public WYYMusicDbContext CreateDbContext(string[] args)
        {
            var optionsBuilder = new DbContextOptionsBuilder<WYYMusicDbContext>();
            ...
            return new WYYMusicDbContext(optionsBuilder.Options); // 这里调用TDbContext的构造函数传入配置 
        } 
    }
}
