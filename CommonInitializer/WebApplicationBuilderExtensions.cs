    ...
    public static class WebApplicationBuilderExtensions
    {
        public static void ConfigureDbConfiguration(this WebApplicationBuilder builder)
        {
            builder.Host.ConfigureAppConfiguration((hostCtx, configBuilder) =>
            {
                ...
                // string connStr = builder.Configuration.GetValue<string>("WYYMusic:ConnStr");
                //string connStr = "Server=LOCALHOST\\SQLEXPRESS;Database=WYYMusic;Trusted_Connection=True;MultipleActiveResultSets=true;TrustServerCertificate=True; ";
                //configBuilder.AddDbConfiguration(() => new SqlConnection(connStr), reloadOnChange: true, reloadInterval: TimeSpan.FromSeconds(5));
                
                string connStr = "server=localhost;port=3306;database=WYYMusic;user=root;password=123456";
        ...
        public static void ConfigureExtraServices(this WebApplicationBuilder builder, InitializerOptions initOptions)
        {
            ...
            services.AddAllDbContexts(ctx =>
            {
                ...
                //因此这里推荐放到环境变量中。
                //string connStr = configuration.GetValue<string>("WYYMusic:ConnStr");
                // 使用sqlserver
                //string connStr = "Server=LOCALHOST\\SQLEXPRESS;Database=WYYMusic;Trusted_Connection=True;MultipleActiveResultSets=true;TrustServerCertificate=True;";
                ...
                // 使用mysql
                string connStr = "server=localhost;port=3306;database=WYYMusic;user=root;password=123456";
                ctx.UseMySql(connStr, new MySqlServerVersion(new Version(8, 0, 32)));
            }, assemblies);
            ...
            services.AddCors(options =>
                {
                    ...
                    options.AddDefaultPolicy(builder => builder/*.WithOrigins(urls)*/  .AllowAnyOrigin()
            ...
            // 引用来自于Zack.Infrastructure的RedLock.net
